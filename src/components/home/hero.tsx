...
export default function Hero() {
  ...
  return (
    <div className="w-full px-4 lg:px-4 xl:px-20">
      ...
      <div className="w-full mt-16  flex flex-col items-center justify-center gap-6 lg:gap-7 xl:gap-10 z-50">
        ...
        <div className="w-full flex items-center justify-center">
          <button className="w-full md:w-auto py-[10px] px-6 lg:px-8 lg:py-3 xl:px-10 xl:py-3 bg-blue-600 xl:text-lg text-white flex items-center justify-center gap-2 lg:hover:bg-black cursor-pointer rounded-full transition-all duration-300">
